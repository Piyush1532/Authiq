...
{state === "Sign Up"  && (
    ...
    <input type="text" placeholder='Full Name' required className='bg-transparent outline-none' onChange={e=>setName(e.target.value)} 
    value={name}/>
  </div>
)}
  ...
  <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
    ...
    <input type="email" placeholder='Email Id' required className='bg-transparent outline-none' onChange={e =>setEmail(e.target.value)} 
    value={email}/>
  </div>

  <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
    <img src={assets.lock_icon} alt="" />
    <input type="password" placeholder='Password' required className='bg-transparent outline-none' onChange={e => setPassword(e.target.value)} 
    value={password} />
  </div>
